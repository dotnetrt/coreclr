        ...
        static unsafe int Main(string[] args)
        {
            ...
            if (Sse2.IsSupported)
            {
                ...
                using (var byteTable = TestTableVector128<byte>.Create(testsCount))
                {
                    ...
                    {
                        int value = x + y;
                        a = (short) (value >= short.MaxValue ? short.MaxValue : value <= short.MinValue ? short.MinValue : value);
                        return a == z;
                    };
                    ...
                    {
                        int value = x + y;
                        a = (ushort)(value >= ushort.MaxValue ? ushort.MaxValue : value);
                        return a == z;
                    };
                    ...
                    {
                        int value = x + y;
                        a = (sbyte)(value >= sbyte.MaxValue ? sbyte.MaxValue : value <= sbyte.MinValue ? sbyte.MinValue : value);
                        return a == z;
                    };
                    ...
                    {
                        int value = x + y;
                        a = (byte)(value >= byte.MaxValue ? byte.MaxValue : value);
                        return a == z;
                    };
